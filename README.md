...
Though to some disappointment it was not as good of an optimization as grid based search was since octrees got us to around 300 boids while grid got 500 (and was much easier to implement).
